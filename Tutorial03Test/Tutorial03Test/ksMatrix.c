...
void ksTranslate(ksMatrix4 *result,float x,float y,float z)
{
    ksMatrix4 temp;
    temp.m[0][0] = 1;
    temp.m[0][1] = 0;
    ...
    temp.m[3][2] = 0;
    temp.m[3][3] = 1;
    ksMatrixMultiply(result, &temp, result);
    
}
void ksRotate(ksMatrix4 *result,float x,float y,float z)
{
    //绕X轴旋转
    ksMatrix4 tempx;
    tempx.m[0][0] = 1;
    ...
    tempx.m[3][2] = 0;
    tempx.m[3][3] = 1;
    ksMatrixMultiply(result, &tempx, result);
    ...
    tempy.m[3][2] = 0;
    tempy.m[3][3] = 1;
    ksMatrixMultiply(result, &tempy, result);
    ...
    tempz.m[3][2] = 0;
    tempz.m[3][3] = 1;
    ksMatrixMultiply(result, &tempz, result);

}
void ksScale(ksMatrix4 *result,float x,float y,float z)
{
    ksMatrix4 temp;
    temp.m[0][0] = x;
    temp.m[0][1] = 0;
...
float ksAngularTransform(float angle)
{
